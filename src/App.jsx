...
const PARTIDOS=[
  {id:"cogs",label:"vs COGS",fecha:"COGS",tipo:"partido",
   prom:{dist:5900,mxm:104,hsr:609,h18:149,spr:25,acc:14,dsc:0,vmax:25.2},
   jugadoras:[
    ...
    {n:"Pareja Camila",   min:64,dist:5617,mxm:87, hsr:255, ai18:57, spr:0,  acc:5, dsc:10,ns:0, vmax:23.0},
    {n:"Muñoz Constanza", min:61,dist:5702,mxm:93, hsr:575, ai18:198,spr:0,  acc:7, dsc:20,ns:0, vmax:23.9},
    {n:"Pollmann Marianne",min:60,dist:6162,mxm:103,hsr:677,ai18:179,spr:0,  acc:12,dsc:17,ns:0, vmax:22.4},
    {n:"Errazu Sofia",    min:56,dist:6298,mxm:111,hsr:434, ai18:69, spr:0,  acc:24,dsc:21,ns:0, vmax:20.7},
    {n:"Sierra Julieta",  min:58,dist:6558,mxm:112,hsr:871, ai18:275,spr:0,  acc:13,dsc:30,ns:0, vmax:23.9},
  ...
  {id:"pwcc",label:"vs PWCC",fecha:"PWCC",tipo:"partido",
   prom:{dist:5797,mxm:102,hsr:774,h18:217,spr:37,acc:18,dsc:0,vmax:24.8},
   jugadoras:[
    {n:"Gomez Camila",    min:41,dist:3996,mxm:95, hsr:569, ai18:130,spr:2,  acc:9, dsc:13,ns:0, vmax:21.0},
    {n:"Pareja Camila",   min:66,dist:5308,mxm:80, hsr:339, ai18:73, spr:0,  acc:6, dsc:9, ns:0, vmax:22.7},
    {n:"Muñoz Constanza", min:66,dist:5406,mxm:82, hsr:462, ai18:224,spr:0,  acc:19,dsc:18,ns:0, vmax:22.5},
    {n:"Errazu Sofia",    min:50,dist:5528,mxm:109,hsr:622, ai18:159,spr:0,  acc:22,dsc:17,ns:0, vmax:21.8},
    {n:"Carrasco Sofia",  min:46,dist:5631,mxm:122,hsr:1121,ai18:378,spr:0,  acc:17,dsc:22,ns:0, vmax:22.9},
    {n:"Silva Victoria",  min:49,dist:5805,mxm:117,hsr:1418,ai18:381,spr:215,acc:31,dsc:36,ns:12,vmax:24.8},
    {n:"Pollmann Marianne",min:57,dist:5945,mxm:103,hsr:487,ai18:90, spr:0,  acc:15,dsc:14,ns:0, vmax:20.3},
    {n:"Sierra Julieta",  min:61,dist:6632,mxm:107,hsr:1061,ai18:357,spr:0,  acc:28,dsc:39,ns:0, vmax:22.6},
    {n:"Gutierrez Renata",min:66,dist:6754,mxm:102,hsr:603, ai18:113,spr:0,  acc:8, dsc:15,ns:0, vmax:21.3},
    {n:"Gacitua Emilia",  min:66,dist:6960,mxm:105,hsr:1055,ai18:263,spr:157,acc:28,dsc:31,ns:8, vmax:24.1},
   ]},
  {id:"manq",label:"vs MANQ",fecha:"MANQ",tipo:"partido",
   prom:{dist:6058,mxm:105,hsr:771,h18:230,spr:2,acc:23,dsc:0,vmax:22.6},
   jugadoras:[
    {n:"Alfaro Javiera",  min:28,dist:3190,mxm:112,hsr:449, ai18:159,spr:0,  acc:9, dsc:16,ns:0, vmax:22.8},
    {n:"Carrasco Sofia",  min:32,dist:3964,mxm:124,hsr:929, ai18:289,spr:0,  acc:26,dsc:42,ns:0, vmax:22.9},
    {n:"Gomez Camila",    min:49,dist:4744,mxm:96, hsr:484, ai18:63, spr:0,  acc:5, dsc:18,ns:0, vmax:20.3},
    {n:"Muñoz Constanza", min:63,dist:5384,mxm:85, hsr:397, ai18:82, spr:0,  acc:12,dsc:17,ns:0, vmax:21.6},
    {n:"Liu Macarena",    min:47,dist:5532,mxm:116,hsr:883, ai18:266,spr:0,  acc:22,dsc:26,ns:0, vmax:22.5},
    {n:"Pareja Camila",   min:71,dist:6123,mxm:86, hsr:281, ai18:62, spr:0,  acc:11,dsc:20,ns:0, vmax:21.2},
    {n:"Gutierrez Renata",min:71,dist:6822,mxm:96, hsr:715, ai18:280,spr:0,  acc:14,dsc:24,ns:0, vmax:22.9},
    {n:"Pollmann Marianne",min:71,dist:6952,mxm:98,hsr:653, ai18:123,spr:0,  acc:27,dsc:14,ns:0, vmax:21.9},
    {n:"Gacitua Emilia",  min:71,dist:7854,mxm:111,hsr:1137,ai18:319,spr:0,  acc:38,dsc:48,ns:0, vmax:23.4},
    {n:"Sierra Julieta",  min:71,dist:7929,mxm:112,hsr:1086,ai18:318,spr:11, acc:39,dsc:61,ns:1, vmax:24.6},
    {n:"Silva Victoria",  min:71,dist:8142,mxm:115,hsr:1469,ai18:570,spr:16, acc:45,dsc:52,ns:1, vmax:24.7},
   ]},

  {id:"catb",label:"vs CAT B",fecha:"CAT B",tipo:"partido",
   prom:{dist:5603,mxm:105,hsr:611,h18:202,spr:2,acc:18,dsc:0,vmax:22.9},
   jugadoras:[
    {n:"Alfaro Javiera",  min:26,dist:2917,mxm:108,hsr:296, ai18:73, spr:0,  acc:4, dsc:15,ns:0, vmax:21.6},
    {n:"Carrasco Sofia",  min:26,dist:3006,mxm:116,hsr:610, ai18:220,spr:0,  acc:20,dsc:40,ns:0, vmax:22.7},
    {n:"Gomez Camila",    min:39,dist:3879,mxm:98, hsr:372, ai18:82, spr:0,  acc:6, dsc:13,ns:0, vmax:20.8},
    {n:"Errazu Sofia",    min:44,dist:5031,mxm:114,hsr:935, ai18:345,spr:5,  acc:23,dsc:18,ns:0, vmax:24.3},
    {n:"Pollmann Marianne",min:63,dist:5874,mxm:92,hsr:567, ai18:169,spr:0,  acc:17,dsc:19,ns:0, vmax:22.9},
    {n:"Pareja Camila",   min:65,dist:6121,mxm:94, hsr:355, ai18:87, spr:0,  acc:15,dsc:16,ns:0, vmax:22.4},
    {n:"Muñoz Constanza", min:65,dist:6258,mxm:96, hsr:390, ai18:125,spr:0,  acc:6, dsc:12,ns:0, vmax:22.6},
    {n:"Sierra Julieta",  min:65,dist:6676,mxm:102,hsr:594, ai18:225,spr:0,  acc:27,dsc:40,ns:0, vmax:23.1},
    {n:"Gutierrez Renata",min:65,dist:6806,mxm:104,hsr:551, ai18:112,spr:0,  acc:19,dsc:18,ns:0, vmax:21.1},
    {n:"Gacitua Emilia",  min:65,dist:7339,mxm:112,hsr:958, ai18:364,spr:9,  acc:29,dsc:35,ns:0, vmax:25.1},
    {n:"Silva Victoria",  min:65,dist:7723,mxm:118,hsr:1096,ai18:419,spr:7,  acc:31,dsc:44,ns:1, vmax:24.8},
   ]},
  {id:"oldreds",label:"vs OLD REDS",fecha:"OLD REDS",tipo:"partido",
   prom:{dist:6161,mxm:104,hsr:869,h18:230,spr:74,acc:19,dsc:0,vmax:25.8},
   jugadoras:[
    {n:"Alfaro Javiera",  min:19,dist:2277,mxm:119,hsr:367, ai18:76, spr:0,  acc:8, dsc:10,ns:0, vmax:20.3},
    {n:"Carrasco Sofia",  min:61,dist:6656,mxm:108,hsr:1241,ai18:404,spr:83, acc:36,dsc:52,ns:6, vmax:22.8},
    {n:"Gomez Camila",    min:35,dist:3292,mxm:91, hsr:251, ai18:46, spr:43, acc:7, dsc:13,ns:2, vmax:23.4},
    {n:"Liu Macarena",    min:64,dist:6993,mxm:109,hsr:1341,ai18:352,spr:89, acc:26,dsc:26,ns:4, vmax:24.1},
    {n:"Pollmann Marianne",min:61,dist:6078,mxm:98,hsr:655, ai18:129,spr:22, acc:16,dsc:23,ns:2, vmax:22.5},
    {n:"Pareja Camila",   min:68,dist:6376,mxm:93, hsr:532, ai18:113,spr:6,  acc:13,dsc:22,ns:1, vmax:22.0},
    {n:"Muñoz Constanza", min:68,dist:6420,mxm:94, hsr:588, ai18:161,spr:41, acc:7, dsc:16,ns:4, vmax:25.7},
    {n:"Sierra Julieta",  min:68,dist:7271,mxm:107,hsr:992, ai18:265,spr:45, acc:25,dsc:49,ns:4, vmax:22.9},
    {n:"Gutierrez Renata",min:68,dist:7141,mxm:105,hsr:896, ai18:155,spr:74, acc:16,dsc:26,ns:4, vmax:24.1},
    {n:"Gacitua Emilia",  min:68,dist:7463,mxm:109,hsr:1216,ai18:365,spr:191,acc:28,dsc:43,ns:12,vmax:24.3},
    {n:"Silva Victoria",  min:68,dist:7802,mxm:114,hsr:1478,ai18:469,spr:222,acc:31,dsc:58,ns:15,vmax:25.8},
   ]},
];
