...
const PARTIDOS=[
  {id:"cogs",label:"vs COGS",fecha:"COGS",tipo:"partido",
   ...
   jugadoras:[
    ...
    {n:"Gacitua Emilia",min:52,dist:5578,mxm:107,hsr:468,ai18:235,spr:137,acc:32,dsc:40,vmax:25.2},
    {n:"Pareja Camila",min:64,dist:5617,mxm:87,hsr:198,ai18:57,spr:0,acc:5,dsc:10,vmax:23.0},
    {n:"Muñoz Constanza",min:61,dist:5702,mxm:93,hsr:377,ai18:198,spr:0,acc:7,dsc:20,vmax:23.9},
    {n:"Pollman Marianne",min:60,dist:6162,mxm:103,hsr:498,ai18:179,spr:0,acc:12,dsc:17,vmax:22.4},
    {n:"Errazu Sofia",min:56,dist:6298,mxm:111,hsr:365,ai18:69,spr:0,acc:24,dsc:21,vmax:20.7},
    {n:"Sierra Julieta",min:58,dist:6558,mxm:112,hsr:596,ai18:275,spr:0,acc:13,dsc:30,vmax:23.9},
    {n:"Silva Victoria",min:57,dist:6681,mxm:117,hsr:773,ai18:310,spr:108,acc:25,dsc:45,vmax:23.4},
  ...
  {id:"pwcc",label:"vs PWCC",fecha:"PWCC",tipo:"partido",
   ...
   jugadoras:[
    {n:"Gomez Camila",min:41,dist:3996,mxm:95,hsr:437,ai18:130,spr:2,acc:9,dsc:13,vmax:21.0},
    {n:"Pareja Camila",min:66,dist:5308,mxm:80,hsr:266,ai18:73,spr:0,acc:6,dsc:9,vmax:22.7},
    {n:"Muñoz Constanza",min:66,dist:5406,mxm:82,hsr:238,ai18:224,spr:0,acc:19,dsc:18,vmax:22.5},
    {n:"Errazu Sofia",min:50,dist:5528,mxm:109,hsr:463,ai18:159,spr:0,acc:22,dsc:17,vmax:21.8},
    {n:"Carrasco Sofia",min:46,dist:5631,mxm:122,hsr:743,ai18:378,spr:0,acc:17,dsc:22,vmax:22.9},
    {n:"Silva Victoria",min:49,dist:5805,mxm:117,hsr:822,ai18:381,spr:215,acc:31,dsc:36,vmax:24.8},
    {n:"Pollmann Marianne",min:57,dist:5945,mxm:103,hsr:397,ai18:90,spr:0,acc:15,dsc:14,vmax:20.3},
    {n:"Sierra Julieta",min:61,dist:6632,mxm:107,hsr:704,ai18:357,spr:0,acc:28,dsc:39,vmax:22.6},
    {n:"Gutierrez Renata",min:66,dist:6754,mxm:102,hsr:490,ai18:113,spr:0,acc:8,dsc:15,vmax:21.3},
    {n:"Gacitua Emilia",min:66,dist:6960,mxm:105,hsr:635,ai18:263,spr:157,acc:28,dsc:31,vmax:24.1},
   ]},
  {id:"manq",label:"vs MANQ",fecha:"MANQ",tipo:"partido",
   ...
   jugadoras:[
    ...
    {n:"Liu Macarena",min:47,dist:5532,mxm:116,hsr:617,ai18:266,spr:0,acc:22,dsc:26,vmax:22.5},
  ...
  {id:"catb",label:"vs CAT B",fecha:"CAT B",tipo:"partido",
   ...
   jugadoras:[
    {n:"Alfaro Javiera",min:26,dist:2917,mxm:108,hsr:223,ai18:73,spr:0,acc:4,dsc:15,vmax:21.6},
    {n:"Carrasco Sofia",min:26,dist:3006,mxm:116,hsr:390,ai18:220,spr:0,acc:20,dsc:40,vmax:22.7},
    {n:"Gomez Camila",min:39,dist:3879,mxm:98,hsr:290,ai18:82,spr:0,acc:6,dsc:13,vmax:20.8},
    {n:"Errazu Sofia",min:44,dist:5031,mxm:114,hsr:585,ai18:345,spr:5,acc:23,dsc:18,vmax:24.3},
    {n:"Pollmann Marianne",min:63,dist:5874,mxm:92,hsr:398,ai18:169,spr:0,acc:17,dsc:19,vmax:22.9},
  ...
  {id:"oldreds",label:"vs OLD REDS",fecha:"OLD REDS",tipo:"partido",
   ...
   jugadoras:[
    ...
    {n:"Gomez Camila",min:35,dist:3292,mxm:91,hsr:162,ai18:46,spr:43,acc:7,dsc:13,vmax:23.4},
    {n:"Liu Macarena",min:64,dist:6993,mxm:109,hsr:900,ai18:352,spr:89,acc:26,dsc:26,vmax:24.1},
    {n:"Pollmann Marianne",min:61,dist:6078,mxm:98,hsr:504,ai18:129,spr:22,acc:16,dsc:23,vmax:22.5},
    {n:"Pareja Camila",min:68,dist:6376,mxm:93,hsr:413,ai18:113,spr:6,acc:13,dsc:22,vmax:22.0},
    {n:"Muñoz Constanza",min:68,dist:6420,mxm:94,hsr:386,ai18:161,spr:41,acc:7,dsc:16,vmax:25.7},
    {n:"Sierra Julieta",min:68,dist:7271,mxm:107,hsr:682,ai18:265,spr:45,acc:25,dsc:49,vmax:22.9},
    {n:"Gutierrez Renata",min:68,dist:7141,mxm:105,hsr:667,ai18:155,spr:74,acc:16,dsc:26,vmax:24.1},
    {n:"Gacitua Emilia",min:68,dist:7463,mxm:109,hsr:660,ai18:365,spr:191,acc:28,dsc:43,vmax:24.3},
    {n:"Silva Victoria",min:68,dist:7802,mxm:114,hsr:787,ai18:469,spr:222,acc:31,dsc:58,vmax:25.8},
   ]},
];
...
const ENTRENOS=[
  {id:"e01",label:"6/04",fecha:"6/04",tipo:"entreno",
   ...
   jugadoras:[
    {n:"Gomez Camila",min:51,dist:5161,mxm:100,hsr:712,ai18:70,spr:0,acc:2,dsc:9,vmax:20.1},
    {n:"Sierra Julieta",min:52,dist:5566,mxm:106,hsr:372,ai18:142,spr:0,acc:24,dsc:31,vmax:22.7},
    {n:"Alfaro Javiera",min:54,dist:6144,mxm:113,hsr:1377,ai18:215,spr:0,acc:6,dsc:16,vmax:20.6},
    {n:"Carrasco Sofia",min:55,dist:6204,mxm:111,hsr:1071,ai18:839,spr:0,acc:22,dsc:22,vmax:22.6},
    {n:"Mateluna Florencia",min:61,dist:6831,mxm:112,hsr:1459,ai18:386,spr:18,acc:27,dsc:18,vmax:21.9},
    {n:"Pareja Camila",min:66,dist:6945,mxm:105,hsr:1320,ai18:61,spr:0,acc:7,dsc:8,vmax:21.5},
    {n:"Pollmann Marianne",min:65,dist:7322,mxm:111,hsr:1484,ai18:454,spr:0,acc:11,dsc:29,vmax:23.0},
    {n:"Gutierrez Renata",min:69,dist:7359,mxm:105,hsr:1625,ai18:302,spr:0,acc:17,dsc:6,vmax:21.1},
    {n:"Errazu Sofia",min:71,dist:7608,mxm:106,hsr:1199,ai18:952,spr:0,acc:37,dsc:9,vmax:22.5},
    {n:"Gacitua Emilia",min:71,dist:7916,mxm:110,hsr:1236,ai18:922,spr:95,acc:29,dsc:33,vmax:24.5},
   ]},
  {id:"e02",label:"8/04",fecha:"8/04",tipo:"entreno",
   ...
   jugadoras:[
    {n:"Pareja Camila",min:21,dist:1365,mxm:64,hsr:440,ai18:195,spr:0,acc:44,dsc:23,vmax:20.6},
    {n:"Carrasco Sofia",min:21,dist:1428,mxm:67,hsr:244,ai18:614,spr:0,acc:47,dsc:40,vmax:23.5},
    {n:"Gomez Camila",min:21,dist:1433,mxm:67,hsr:563,ai18:120,spr:2,acc:35,dsc:25,vmax:21.0},
    {n:"Alfaro Javiera",min:21,dist:1464,mxm:69,hsr:472,ai18:300,spr:0,acc:42,dsc:28,vmax:21.1},
    {n:"Pollmann Marianne",min:21,dist:1487,mxm:70,hsr:481,ai18:213,spr:0,acc:38,dsc:21,vmax:20.6},
    {n:"Gutierrez Renata",min:21,dist:1545,mxm:72,hsr:402,ai18:421,spr:0,acc:44,dsc:30,vmax:21.6},
    {n:"Mateluna Florencia",min:21,dist:1582,mxm:74,hsr:449,ai18:364,spr:3,acc:50,dsc:25,vmax:21.1},
    {n:"Gacitua Emilia",min:21,dist:1594,mxm:75,hsr:286,ai18:503,spr:67,acc:46,dsc:27,vmax:22.9},
   ]},
  {id:"e03",label:"10/04",fecha:"10/04",tipo:"entreno",
   ...
   jugadoras:[
    {n:"Gomez Camila",min:19,dist:1161,mxm:58,hsr:151,ai18:109,spr:52,acc:30,dsc:7,vmax:23.2},
    {n:"Gutierrez Renata",min:19,dist:1221,mxm:61,hsr:127,ai18:187,spr:37,acc:30,dsc:7,vmax:26.9},
    {n:"Pollmann Marianne",min:19,dist:1275,mxm:64,hsr:133,ai18:213,spr:0,acc:30,dsc:2,vmax:24.7},
    {n:"Carrasco Sofia",min:19,dist:1310,mxm:66,hsr:100,ai18:304,spr:30,acc:30,dsc:17,vmax:26.5},
    {n:"Alfaro Javiera",min:19,dist:1322,mxm:66,hsr:142,ai18:211,spr:4,acc:30,dsc:0,vmax:25.3},
    {n:"Gacitua Emilia",min:19,dist:1408,mxm:71,hsr:85,ai18:138,spr:187,acc:31,dsc:17,vmax:28.5},
    {n:"Mateluna Florencia",min:19,dist:1412,mxm:71,hsr:134,ai18:157,spr:101,acc:30,dsc:1,vmax:26.2},
   ]},
  {id:"e04",label:"13/04",fecha:"13/04",tipo:"entreno",
   prom_hsr:452,prom_h18:295,prom_spr:0,
   zonas:[
   ...
   jugadoras:[
    {n:"Errazu Sofia",min:12,dist:1123,mxm:88,hsr:304,ai18:332,spr:3,acc:12,dsc:8,vmax:24.5},
    {n:"Pollmann Marianne",min:15,dist:1349,mxm:110,hsr:414,ai18:232,spr:0,acc:9,dsc:4,vmax:23.1},
    {n:"Gutierrez Renata",min:15,dist:1477,mxm:95,hsr:655,ai18:54,spr:0,acc:4,dsc:0,vmax:19.6},
    {n:"Gomez Camila",min:15,dist:1536,mxm:97,hsr:459,ai18:52,spr:0,acc:5,dsc:3,vmax:20.9},
    {n:"Pastenes Nicole",min:15,dist:1582,mxm:100,hsr:317,ai18:101,spr:0,acc:3,dsc:1,vmax:21.7},
    {n:"Carrasco Sofia",min:15,dist:1638,mxm:106,hsr:436,ai18:525,spr:0,acc:20,dsc:11,vmax:23.8},
    {n:"Mateluna Florencia",min:15,dist:1666,mxm:108,hsr:705,ai18:297,spr:0,acc:27,dsc:8,vmax:21.0},
    {n:"Gacitua Emilia",min:15,dist:1693,mxm:109,hsr:394,ai18:501,spr:0,acc:16,dsc:9,vmax:23.7},
    {n:"Sepulveda Eileen",min:15,dist:1714,mxm:115,hsr:383,ai18:564,spr:0,acc:23,dsc:11,vmax:23.6},
   ]},
  {id:"e05",label:"15/04",fecha:"15/04",tipo:"entreno",
   ...
   jugadoras:[
    {n:"Arau Maria",min:57,dist:1413,mxm:24,hsr:39,ai18:0,spr:0,acc:7,dsc:1,vmax:17.0},
    {n:"Pollmann Marianne",min:47,dist:3472,mxm:74,hsr:389,ai18:52,spr:0,acc:35,dsc:20,vmax:19.9},
    {n:"Gomez Camila",min:47,dist:3557,mxm:75,hsr:317,ai18:8,spr:0,acc:20,dsc:32,vmax:18.9},
    {n:"Pareja Camila",min:47,dist:3807,mxm:80,hsr:430,ai18:22,spr:0,acc:44,dsc:32,vmax:21.4},
    {n:"Alfaro Javiera",min:47,dist:396,mxm:84,hsr:393,ai18:24,spr:0,acc:20,dsc:22,vmax:21.0},
    {n:"Retamal Antonia",min:47,dist:4183,mxm:88,hsr:579,ai18:43,spr:0,acc:45,dsc:26,vmax:20.8},
    {n:"Gacitua Emilia",min:52,dist:4407,mxm:83,hsr:792,ai18:112,spr:0,acc:66,dsc:57,vmax:22.3},
    {n:"Carrasco Sofia",min:52,dist:4906,mxm:93,hsr:983,ai18:238,spr:0,acc:64,dsc:71,vmax:22.7},
    {n:"Sepulveda Eileen",min:52,dist:5087,mxm:96,hsr:747,ai18:86,spr:0,acc:47,dsc:46,vmax:20.2},
   ]},
  {id:"e06",label:"17/04",fecha:"17/04",tipo:"entreno",
   ...
   jugadoras:[
    {n:"Sepulveda Eileen",min:5,dist:396,mxm:71,hsr:30,ai18:47,spr:5,acc:5,dsc:0,vmax:24.5},
    {n:"Alfaro Javiera",min:7,dist:720,mxm:98,hsr:100,ai18:244,spr:22,acc:15,dsc:3,vmax:25.5},
    {n:"Retamal Antonia",min:11,dist:1288,mxm:111,hsr:207,ai18:603,spr:29,acc:29,dsc:28,vmax:25.4},
    {n:"Pareja Camila",min:16,dist:1828,mxm:111,hsr:566,ai18:348,spr:1,acc:35,dsc:5,vmax:24.1},
    {n:"Gutierrez Renata",min:16,dist:1883,mxm:114,hsr:638,ai18:400,spr:38,acc:31,dsc:19,vmax:25.4},
    {n:"Carrasco Sofia",min:16,dist:1902,mxm:116,hsr:338,ai18:818,spr:59,acc:44,dsc:15,vmax:25.5},
    {n:"Mateluna Florencia",min:16,dist:1956,mxm:119,hsr:496,ai18:638,spr:26,acc:47,dsc:11,vmax:25.1},
    {n:"Gacitua Emilia",min:16,dist:1976,mxm:120,hsr:306,ai18:763,spr:138,acc:40,dsc:14,vmax:27.1},
   ]},
  {id:"e07",label:"20/04",fecha:"20/04",tipo:"entreno",
   ...
   jugadoras:[
    {n:"Errazu Sofia",min:16,dist:1558,mxm:95,hsr:192,ai18:66,spr:0,acc:9,dsc:7,vmax:20.9},
    {n:"Sierra Julieta",min:32,dist:3793,mxm:117,hsr:296,ai18:112,spr:0,acc:8,dsc:14,vmax:21.9},
    {n:"Gomez Camila",min:41,dist:3979,mxm:97,hsr:255,ai18:65,spr:0,acc:14,dsc:16,vmax:21.4},
    {n:"Pollmann Marianne",min:55,dist:4954,mxm:102,hsr:351,ai18:92,spr:0,acc:5,dsc:14,vmax:21.3},
    {n:"Alfaro Javiera",min:59,dist:5627,mxm:95,hsr:196,ai18:35,spr:5,acc:10,dsc:16,vmax:25.4},
    {n:"Muñoz Constanza",min:65,dist:5780,mxm:88,hsr:305,ai18:46,spr:0,acc:13,dsc:9,vmax:21.0},
    {n:"Silva Victoria",min:51,dist:586,mxm:114,hsr:606,ai18:207,spr:0,acc:25,dsc:30,vmax:22.8},
    {n:"Carrasco Sofia",min:54,dist:5897,mxm:108,hsr:637,ai18:382,spr:0,acc:31,dsc:50,vmax:23.3},
    {n:"Pareja Camila",min:67,dist:6049,mxm:89,hsr:284,ai18:112,spr:0,acc:19,dsc:15,vmax:21.1},
    {n:"Gutierrez Renata",min:67,dist:6505,mxm:96,hsr:450,ai18:146,spr:0,acc:21,dsc:18,vmax:21.9},
    {n:"Gacitua Emilia",min:63,dist:6694,mxm:106,hsr:617,ai18:434,spr:13,acc:36,dsc:33,vmax:26.0},
   ]},
  {id:"e08",label:"22/04",fecha:"22/04",tipo:"entreno",
   ...
   jugadoras:[
    {n:"Muñoz Constanza",min:33,dist:2667,mxm:82,hsr:859,ai18:913,spr:0,acc:8,dsc:1,vmax:20.9},
   ]},
  {id:"e09",label:"29/04",fecha:"29/04",tipo:"entreno",
   ...
   jugadoras:[
    {n:"Arau Maria",min:68,dist:1710,mxm:25,hsr:19,ai18:4,spr:0,acc:9,dsc:0,vmax:18.6},
    {n:"Gomez Camila",min:72,dist:3574,mxm:50,hsr:280,ai18:10,spr:0,acc:3,dsc:17,vmax:18.5},
    {n:"Gacitua Emilia",min:72,dist:5052,mxm:70,hsr:525,ai18:725,spr:124,acc:45,dsc:27,vmax:27.7},
    {n:"Pareja Camila",min:72,dist:5118,mxm:71,hsr:674,ai18:265,spr:15,acc:29,dsc:16,vmax:24.6},
    {n:"Alfaro Javiera",min:72,dist:5318,mxm:74,hsr:620,ai18:506,spr:42,acc:29,dsc:28,vmax:25.3},
    {n:"Retamal Antonia",min:72,dist:5507,mxm:76,hsr:808,ai18:474,spr:82,acc:42,dsc:35,vmax:25.4},
    {n:"Gutierrez Renata",min:72,dist:5525,mxm:77,hsr:658,ai18:331,spr:9,acc:27,dsc:23,vmax:24.5},
    {n:"Carrasco Sofia",min:72,dist:5552,mxm:77,hsr:542,ai18:841,spr:119,acc:51,dsc:58,vmax:26.4},
  ...
  {id:"e10",label:"4/05",fecha:"4/05",tipo:"entreno",
   ...
   jugadoras:[
    {n:"Arau Maria",min:9,dist:384,mxm:42,hsr:3,ai18:0,spr:0,acc:7,dsc:2,vmax:15.6},
    {n:"Gomez Camila",min:25,dist:987,mxm:39,hsr:99,ai18:14,spr:0,acc:27,dsc:8,vmax:18.5},
    {n:"Alfaro Javiera",min:25,dist:993,mxm:39,hsr:77,ai18:68,spr:0,acc:28,dsc:10,vmax:21.1},
    {n:"Gutierrez Renata",min:25,dist:994,mxm:40,hsr:80,ai18:59,spr:0,acc:30,dsc:9,vmax:20.4},
    {n:"Pareja Camila",min:25,dist:1028,mxm:41,hsr:76,ai18:40,spr:0,acc:26,dsc:7,vmax:19.4},
    {n:"Carrasco Sofia",min:25,dist:1035,mxm:41,hsr:91,ai18:98,spr:0,acc:33,dsc:13,vmax:21.0},
    {n:"Gacitua Emilia",min:25,dist:1095,mxm:44,hsr:81,ai18:120,spr:0,acc:29,dsc:8,vmax:22.0},
    {n:"Errazu Sofia",min:25,dist:1133,mxm:45,hsr:83,ai18:105,spr:0,acc:30,dsc:10,vmax:20.7},
    {n:"Mateluna Florencia",min:25,dist:1146,mxm:46,hsr:96,ai18:89,spr:0,acc:37,dsc:6,vmax:20.8},
   ]},
  {id:"e11",label:"11/05",fecha:"11/05",tipo:"entreno",
   ...
   jugadoras:[
    {n:"Arau Maria",min:65,dist:1935,mxm:30,hsr:32,ai18:0,spr:0,acc:8,dsc:6,vmax:17.4},
    {n:"Gomez Camila",min:65,dist:3262,mxm:50,hsr:122,ai18:17,spr:0,acc:16,dsc:22,vmax:19.3},
    {n:"Gutierrez Renata",min:65,dist:3604,mxm:55,hsr:180,ai18:51,spr:0,acc:33,dsc:24,vmax:21.1},
    {n:"Carrasco Sofia",min:65,dist:3628,mxm:56,hsr:327,ai18:84,spr:0,acc:46,dsc:66,vmax:20.4},
    {n:"Mateluna Florencia",min:65,dist:3660,mxm:56,hsr:175,ai18:34,spr:0,acc:39,dsc:31,vmax:21.0},
    {n:"Pareja Camila",min:65,dist:3773,mxm:58,hsr:260,ai18:26,spr:0,acc:29,dsc:22,vmax:21.8},
    {n:"Alfaro Javiera",min:65,dist:3820,mxm:59,hsr:161,ai18:46,spr:0,acc:26,dsc:33,vmax:20.6},
    {n:"Hevia Valentina",min:65,dist:3892,mxm:60,hsr:190,ai18:26,spr:0,acc:30,dsc:28,vmax:19.4},
    {n:"Gacitua Emilia",min:65,dist:4008,mxm:62,hsr:206,ai18:184,spr:0,acc:41,dsc:45,vmax:23.3},
    {n:"Errazu Sofia",min:65,dist:4020,mxm:62,hsr:284,ai18:68,spr:0,acc:39,dsc:38,vmax:21.7},
    {n:"Retamal Antonia",min:65,dist:4083,mxm:63,hsr:243,ai18:62,spr:0,acc:36,dsc:50,vmax:20.7},
   ]},
  {id:"e12",label:"13/05",fecha:"13/05",tipo:"entreno",
   ...
   jugadoras:[
    {n:"Arau Maria",min:54,dist:1514,mxm:28,hsr:26,ai18:0,spr:0,acc:16,dsc:2,vmax:17.0},
    {n:"Pollmann Marianne",min:51,dist:3107,mxm:60,hsr:288,ai18:210,spr:8,acc:15,dsc:8,vmax:24.9},
    {n:"Pareja Camila",min:50,dist:3666,mxm:73,hsr:280,ai18:411,spr:4,acc:35,dsc:16,vmax:24.5},
    {n:"Gutierrez Renata",min:50,dist:3736,mxm:74,hsr:297,ai18:530,spr:14,acc:27,dsc:21,vmax:25.8},
    {n:"Gacitua Emilia",min:51,dist:4106,mxm:79,hsr:301,ai18:632,spr:125,acc:48,dsc:33,vmax:28.0},
    {n:"Retamal Antonia",min:50,dist:4194,mxm:83,hsr:399,ai18:416,spr:86,acc:28,dsc:23,vmax:25.4},
    {n:"Mateluna Florencia",min:50,dist:4293,mxm:85,hsr:352,ai18:508,spr:120,acc:51,dsc:37,vmax:25.9},
    {n:"Silva Victoria",min:51,dist:4311,mxm:83,hsr:382,ai18:585,spr:117,acc:49,dsc:46,vmax:26.4},
    {n:"Carrasco Sofia",min:51,dist:4341,mxm:84,hsr:390,ai18:689,spr:13,acc:45,dsc:53,vmax:26.1},
    {n:"Sierra Julieta",min:50,dist:4359,mxm:86,hsr:287,ai18:538,spr:168,acc:47,dsc:49,vmax:26.7},
   ]},
  {id:"e13",label:"18/05",fecha:"18/05",tipo:"entreno",
   ...
   jugadoras:[
    {n:"Arau Maria",min:74,dist:1521,mxm:20,hsr:0,ai18:0,spr:0,acc:4,dsc:0,vmax:14.4},
    {n:"Gutierrez Renata",min:74,dist:3281,mxm:44,hsr:112,ai18:22,spr:0,acc:23,dsc:24,vmax:20.1},
    {n:"Alfaro Javiera",min:74,dist:3314,mxm:44,hsr:99,ai18:19,spr:0,acc:31,dsc:22,vmax:20.6},
    {n:"Mateluna Florencia",min:74,dist:3356,mxm:45,hsr:217,ai18:77,spr:4,acc:43,dsc:34,vmax:21.4},
    {n:"Gacitua Emilia",min:74,dist:3367,mxm:45,hsr:218,ai18:150,spr:46,acc:56,dsc:40,vmax:23.1},
    {n:"Carrasco Sofia",min:74,dist:3425,mxm:46,hsr:233,ai18:67,spr:4,acc:42,dsc:47,vmax:21.6},
    {n:"Gomez Camila",min:74,dist:3614,mxm:48,hsr:102,ai18:13,spr:0,acc:24,dsc:22,vmax:18.9},
    {n:"Pollmann Marianne",min:74,dist:3707,mxm:50,hsr:163,ai18:30,spr:2,acc:39,dsc:39,vmax:21.3},
    {n:"Hevia Valentina",min:74,dist:3726,mxm:50,hsr:175,ai18:42,spr:0,acc:31,dsc:25,vmax:20.0},
    {n:"Pareja Camila",min:74,dist:3951,mxm:53,hsr:144,ai18:25,spr:9,acc:33,dsc:30,vmax:21.7},
    {n:"Retamal Antonia",min:74,dist:4082,mxm:55,hsr:184,ai18:90,spr:7,acc:52,dsc:54,vmax:21.4},
   ]},
  {id:"e14",label:"20/05",fecha:"20/05",tipo:"entreno",
   prom_hsr:347,prom_h18:277,prom_spr:224,
   zonas:[
    {n:"Arau Maria",h15:31,h18:7,spr:0},
    {n:"Pollman Marianne",h15:141,h18:32,spr:40},
   ...
   jugadoras:[
    {n:"Arau Maria",min:67,dist:1919,mxm:29,hsr:32,ai18:7,spr:0,acc:13,dsc:5,vmax:19.2},
    {n:"Pollman Marianne",min:33,dist:1958,mxm:58,hsr:141,ai18:32,spr:40,acc:4,dsc:3,vmax:23.4},
    {n:"Gacitua Emilia",min:30,dist:2548,mxm:84,hsr:153,ai18:152,spr:413,acc:31,dsc:23,vmax:28.0},
    {n:"Silva Victoria",min:41,dist:3787,mxm:91,hsr:298,ai18:188,spr:21,acc:23,dsc:51,vmax:22.3},
    {n:"Gomez Camila",min:54,dist:4291,mxm:78,hsr:477,ai18:324,spr:171,acc:26,dsc:19,vmax:23.2},
    {n:"Gutierrez Renata",min:51,dist:4475,mxm:86,hsr:401,ai18:254,spr:275,acc:31,dsc:33,vmax:24.7},
    {n:"Alfaro Javiera",min:57,dist:4647,mxm:81,hsr:568,ai18:312,spr:262,acc:31,dsc:34,vmax:26.0},
    {n:"Pareja Camila",min:55,dist:4893,mxm:89,hsr:469,ai18:282,spr:249,acc:45,dsc:23,vmax:25.0},
    {n:"Sierra Julieta",min:53,dist:5040,mxm:94,hsr:443,ai18:574,spr:151,acc:67,dsc:77,vmax:23.4},
    {n:"Carrasco Sofia",min:60,dist:5114,mxm:85,hsr:423,ai18:491,spr:439,acc:49,dsc:62,vmax:25.6},
    {n:"Mateluna Florencia",min:56,dist:5308,mxm:94,hsr:415,ai18:427,spr:443,acc:55,dsc:53,vmax:26.6},
   ]},
];
...
const MINUTOS=[
  ...
  {n:"Muñoz Costanza",cogs:60,pwcc:60,manq:53,catb:60,reds:60,tot:293,prom:58.6},
